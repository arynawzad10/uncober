<?php
ob_start();
$API_KEY = "1056352437:AAGLhvJB9CPLfZdyAcUMIHqtUpos6utc6UQ";//توكنك
$buy = "@TH3SS";// معرفك
$sudo = "1165017371";//ايديك
$admin = "$sudo";// ماتغير شي
$idBot = "1295777668";// ايدي بوتك
$admmm = $sudo;//ماتغير شي
$Dev = array("$sudo", "" );
$userrr = "THSLBOT";// معرف بوتك بدون @
...
if($text =="السورس" || $text =="سورس"){
	...
	'chat_id'=>$chat_id,
	'text'=>"*┄─┅══┅─┄     
👋│اهلا بك في سورس النيزك ⚜
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
📡╿*[قناة السورس العامة](t.me/thtss)*
⚜│*[قناة شروحات السورس](https://t.me/TH1BS)*
🛒│*[فريق متجر لمسات](https://t.me/dTH3SS) *
👨🏻‍✈️╽*[مطور السـورس](t.me/th3ss)*
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
*",
    'disable_web_page_preview'=>true,
    'parse_mode'=>"MARKDOWN",
...
$ZhName = str_replace("زخرفه ","",$text);
if($text == "زخرفه $ZhName"){
$GetZh = json_decode(file_get_contents("https://sufi-mustafa1.000webhostapp.com/zhrf.php?text=".urlencode($ZhName)),true);
$Zh = $GetZh["result"];
$k = ""; 
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=> "$k تم الزخرفه اضغط ليتم النسخ",
'parse_mode'=>"MarkDown"
]);
}
